...
OMX_SETTINGS_COMMON_SRCS+=\
  ...
  $(THIS.omx_settings_common)/omx_settings_common.cpp\
  $(THIS.omx_settings_common)/omx_settings_common_avc.cpp\
  $(THIS.omx_settings_common)/omx_settings_common_hevc.cpp\
