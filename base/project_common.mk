...
include $(THIS.base_common)/omx_settings/project_common.mk
include $(THIS.base_common)/omx_mediatype/project_common.mk
include $(THIS.base_common)/omx_utils/project.mk
...
OMX_COMMON_OBJ+=$(OMX_SETTINGS_COMMON_SRCS:%=$(BIN)/%.o)
OMX_COMMON_OBJ+=$(OMX_MEDIATYPE_COMMON_SRCS:%=$(BIN)/%.o)
OMX_COMMON_OBJ+=$(OMX_UTILS_SRCS:%=$(BIN)/%.o)
